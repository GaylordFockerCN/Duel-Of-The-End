 ...
 * 方便统一调难度
 */
public abstract class DOTEBoss extends PathfinderMob implements NpcDialogue, ShadowableEntity, LevelableEntity, MultiPlayerBoostEntity {
    public static final Map<UUID, Integer> SERVER_BOSSES = new HashMap<>();//用于客户端渲染bossBar
    @Nullable
    protected Player conversingPlayer;
    protected static final EntityDataAccessor<Boolean> IS_FIGHTING = SynchedEntityData.defineId(DOTEBoss.class, EntityDataSerializers.BOOLEAN);
    protected static final EntityDataAccessor<Boolean> IS_SHADER = SynchedEntityData.defineId(DOTEBoss.class, EntityDataSerializers.BOOLEAN);
