...
public class JellyCatModel extends GeoModel<JellyCat> {
    ...
    public ResourceLocation getModelResource(JellyCat animatable) {
        return new ResourceLocation(TheCasketOfReveriesMod.MOD_ID, "geo/jelly_cat.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(JellyCat animatable) {
        String cat = "jelly_cat_"+animatable.getSkinID()+"_"+animatable.getFaceID().ordinal()+".png";
    ...
    public ResourceLocation getAnimationResource(JellyCat animatable) {
        return new ResourceLocation(TheCasketOfReveriesMod.MOD_ID, "animations/jelly_cat.animation.json");
    }
}
