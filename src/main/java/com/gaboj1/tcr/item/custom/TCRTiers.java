...
public enum TCRTiers implements Tier {
    ...
    TCRTiers(int p_43332_, int p_43333_, float p_43334_, float p_43335_, int p_43336_, Supplier p_43337_) {
        this.level = p_43332_;
        this.uses = p_43333_;
        this.speed = p_43334_;
        this.damage = p_43335_;
        this.enchantmentValue = p_43336_;
        this.repairIngredient = new LazyLoadedValue<Ingredient>(p_43337_);
    }
