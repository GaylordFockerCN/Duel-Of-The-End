...
public class TCRFoods {
    ...
    public static final FoodProperties GOLDEN_WIND_AND_DEW = new FoodProperties.Builder().nutrition(2).alwaysEat().saturationMod(0.2f).effect(()->new MobEffectInstance(MobEffects.GLOWING,2000),1.0f).effect(()->new MobEffectInstance(MobEffects.MOVEMENT_SPEED,2000),1.0F).effect(()->new MobEffectInstance(MobEffects.DAMAGE_BOOST,2000),1.0F).build();
    ...
    //大力丸（增加伤害）
    public static final FoodProperties POWER_PELLET = new FoodProperties.Builder().nutrition(1).alwaysEat().saturationMod(0.2f).effect(()->new MobEffectInstance(MobEffects.DAMAGE_BOOST, 1000), 1.0f).build();
    //碧藕金丹（加生命上限）
    public static final FoodProperties GOLDEN_PELLET = new FoodProperties.Builder().nutrition(1).alwaysEat().saturationMod(0.2f).effect(()->new MobEffectInstance(TCREffects.HEALTH_BOOST.get(), 1), 1.0f).build();
