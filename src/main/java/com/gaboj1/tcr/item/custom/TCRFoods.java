...
public class TCRFoods {
    public static final FoodProperties DRINK = new FoodProperties.Builder().nutrition(2).alwaysEat().saturationMod(0.2f).build();
    public static final FoodProperties DREAM_DA = new FoodProperties.Builder().nutrition(2).alwaysEat().saturationMod(0.2f).effect(()->new MobEffectInstance(MobEffects.CONFUSION,200),0.5f).build();
