...
public class TCRFoods {
    public static final FoodProperties COMMON = new FoodProperties.Builder().nutrition(4).alwaysEat().saturationMod(0.2f).effect(()->new MobEffectInstance(MobEffects.REGENERATION,800),0.5f).effect(()->new MobEffectInstance(MobEffects.MOVEMENT_SPEED,200),0.5f).build();
