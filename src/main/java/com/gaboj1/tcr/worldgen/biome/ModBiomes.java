...
public class ModBiomes {
    public static final ResourceKey<Biome> DENSE_FOREST_BIOME = ResourceKey.create(Registries.BIOME,
            new ResourceLocation(TheCasketOfReveriesMod.MOD_ID, "dense_forest_biome"));

    public static void boostrap(BootstapContext<Biome> context) {
        context.register(DENSE_FOREST_BIOME, createDenseForestBiome(context));
    }
