...
public class TFSurfaceRules {
    ...
    private static final SurfaceRules.RuleSource WEATHERED_DEADROCK = makeStateRule(Blocks.STONE_BRICKS);
    private static final SurfaceRules.RuleSource CRACKED_DEADROCK = makeStateRule(Blocks.CRACKED_STONE_BRICKS);
    private static final SurfaceRules.RuleSource DEADROCK = makeStateRule(Blocks.STONE_BRICKS);
...
//                                                        GRAVEL))))));
                ...
                SurfaceRules.ifTrue(SurfaceRules.ON_FLOOR,
                        SurfaceRules.sequence(
                                SurfaceRules.ifTrue(
                                        ...
                                        SurfaceRules.isBiome(ModBiomes.AIR),
                                        SurfaceRules.sequence(
        ...
        builder
                ...
                .add(SurfaceRules.ifTrue(SurfaceRules.verticalGradient("bedrock_floor", VerticalAnchor.bottom(), VerticalAnchor.aboveBottom(5)), AIR))
//                .add(highlandsNoise)
//                .add(deadrockLands)
//                .add(snowyForest)
//                .add(glacier)
