...
public class SoundGenerator extends TCRSoundProvider {
    ...
    public void registerSounds() {
        ...
        this.generateNewSoundWithSubtitle(TCRModSounds.TREE_MONSTERS_DEATH, "item/tree_monsters/tree_monsters_death", 1);
        this.generateNewSoundWithSubtitle(TCRModSounds.TREE_MONSTERS_HURT, "item/tree_monsters/tree_monsters_hurt", 1);
