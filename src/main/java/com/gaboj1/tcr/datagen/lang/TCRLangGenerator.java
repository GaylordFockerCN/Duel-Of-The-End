...
public class TCRLangGenerator extends TCRLangProvider {
    ...
    protected void addTranslations() {
        ...
        this.addItemUsageInfo(TCRItems.PI_PA.get(),"妙音的带有魔力的琵琶，右键以释放音波弹，但最好不要用它来敲击东西。");
        ...
        this.addDialog(TCREntities.CANG_LAN,3,"迫于盟主武力高强，我们只能任人鱼肉。更可恨的是，他们独占资源，囤积武学秘籍，接连下达禁令，美其名曰维护江湖秩序。");
