package com.p1nero.dote.entity.custom.npc.abyss_dweller;
 ...
 * 凝渊人，引导的npc
 */
public class AbyssDwellerEntity extends DOTENpc {

    public AbyssDwellerEntity(EntityType<? extends PathfinderMob> entityType, Level level) {
