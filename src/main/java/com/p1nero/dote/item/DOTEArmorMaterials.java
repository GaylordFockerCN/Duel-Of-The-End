...
public enum DOTEArmorMaterials implements ArmorMaterial {
    ...
    WHITEKNIGHT("whiteknight", 37, new int[]{ 3, 6, 8, 3}, 15,
            SoundEvents.ARMOR_EQUIP_DIAMOND, 1f, 0.3f, () -> Ingredient.of(DOTEItems.WKNIGHT_INGOT.get())),
    NETHERITEROT("netheriterot", 37, new int[]{ 3, 6, 8, 3}, 15,
        SoundEvents.ARMOR_EQUIP_NETHERITE, 3f, 0.3f, () -> Ingredient.of(DOTEItems.NETHERROT_INGOT.get())),
