...
import com.p1nero.dote.entity.ai.ef.DOTEBossTargetChasingGoal;
...
import static com.p1nero.dote.entity.custom.DOTEBoss.ATTACK_SPEED;

public abstract class DOTEBossPatch<T extends DOTEBoss> extends HumanoidMobPatch<T> implements IModifyStunTypeEntityPatch, IModifyAttackDamageEntityPatch, ITimeEventListEntityPatch, IModifyAttackSpeedEntityPatch , IMultiPhaseEntityPatch {
    ...
    public DOTEBossPatch(Faction faction) {
        super(faction);
    }
...
//            this.original.goalSelector.addGoal(0, new GoldenFlameAnimatedAttackGoal<>(this, builder.build(this)));
            ...
            this.original.goalSelector.addGoal(1, new DOTEBossTargetChasingGoal(this, this.getOriginal(), 1.0, true));
        }
    }
