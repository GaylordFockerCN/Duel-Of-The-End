package com.p1nero.dote.worldgen.noise;
...
public class DOTENoiseSettings {
    ...
    public static void bootstrap(BootstapContext<NoiseGeneratorSettings> context) {
        ...
        context.register(PLAIN, DOTENoiseBuilders.plainNoiseSettings(densityFunctions, noise));
    }
